...
class User(UserMixin, db.Model):
    ...
    def is_following(self, user):
        """
        Check if the user who is about to be followed is already followed
        """
    ...
    def followed_posts(self):
        """
        Brings the followed user's posts into the following users timeline
        """
    ...
    def avatar(self, size="80"):
        ...
        """
        # One could add nosec to ignore bandit messages
        # I added sha256 instead md5 because it more secure but not sha512
        # because I want to avoid exessive computation processes at
        # the current time.
